...
const Comment = forwardRef(({ comment, username, new_time, profile, email }, ref) => {
  ...
  return (
    <div className="main">
      <div ref={ref} className="message">
        <Card className={auth?.currentUser?.email === email ? "message__user" : "message__guestCard"} >
          <CardContent>
            ...
            >
              ...
              <Typography style={{
                  marginRight: 10,
                  color: auth?.currentUser?.email === email ? "black" : "white"
              }} color={auth?.currentUser?.email === email ? "black" : "white"} variant="p" component="p">
                {col}
              </Typography>

              {/*The rest of the message separated from the highlighted one*/}
              <Typography color={auth?.currentUser?.email === email ? "black" : "white"} variant="p" component="p">
                {one.join(" ")}
              </Typography>
